...
?></table>
		        ...
		        <section id="tmpl-structure">
					...
					<br> 
				<center>	<h2> ثبت نام در تمامی رویداد ها 30 روز پیش از برگزاری هر رویداد امکان پذیر است  </h2>
					...
					<div class="single-cat-widget">
						<div class="content relative">
							<div class="overlay overlay-bg"></div>	
								...
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/blog/5s.jpg" alt="">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">سمینار آموزشی پنج اس</h4>
									<span></span>
									<p>نظام آراستگی (مدیریت) - 21 تیر ماه </p>
								</div>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							<div class="overlay overlay-bg"></div>						
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/blog/6s.jpg" alt="">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">سمینار آموزشی شش سیگما</h4>
									<span></span>
									<p>نظام آراستگی (مدیریت)- 28 تیر ماه</p>
							</div>
